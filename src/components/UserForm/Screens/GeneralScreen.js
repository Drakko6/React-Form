        ...
        <Grid container xs={12}>
          <SectionContainer container xs={12}>
            <form style={{ width: "100%" }}>
              <SimpleFormInput label="Razón social">
                <FormControl
                  variant="outlined"
              ...
              <SimpleFormInput label="Nombre comercial">
                <TextField
                  id="commercialName"
                  name="commercialName"
                  style={{ margin: 15, width: "100%" }}
              ...
              <SimpleFormInput label="Fecha de constitución">
                <TextField
              ...
              <SimpleFormInput label="Fecha de inicio">
                <TextField
              ...
              <SimpleFormInput label="Régimen fiscal">
                <FormControl
                  variant="outlined"
                  style={{ margin: 15, width: "100%" }}
                  size="small"
              ...
              <SimpleFormInput label="Industria">
                <FormControl
                  variant="outlined"
                  style={{ margin: 15, width: "100%" }}
                  size="small"
